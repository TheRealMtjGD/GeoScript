...
def gsusage():
    ...
    print('geoscript build [SourceFile] [GQCFile] -o : Compiles your source file to a .gqc file')
    print('geoscript build [.gso file] [LevelName] -gso : Compiles a quick compile file')
